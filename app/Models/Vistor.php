...
class Vistor extends Model
{
    ...
    public static function saveVisitor()
    {
        try {
            ...
            $row->country    = HelperService::ip_info(request()->ip());
    ...
    {
        return self::whereRaw('WEEKDAY(created_at)='.$day)->whereYear('at_date', date('Y'))->count();
    }
    ...
    {
        return self::whereMonth('at_date', $month)->whereYear('at_date', date('Y'))->count();
    }
